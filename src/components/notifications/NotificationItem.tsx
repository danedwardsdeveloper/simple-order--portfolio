...
import { NotificationInterface, NotificationLevels } from '@/providers/notifications'
        ...
        <div className="p-4">
          <div className="flex items-start">
            ...
            <div className="ml-3 w-0 flex-1 pt-0.5">
              <p className={clsx('text-sm font-medium text-red-50', colourStyles[notification.level].title)}>
                {notification.title}
              </p>
              <p className={clsx('mt-1 text-sm', colourStyles[notification.level].message)}>
