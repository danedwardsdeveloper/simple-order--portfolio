			...
			{isLoading ? (
				...
				<form onSubmit={handleSubmit}>
					...
					<div className="mt-4 flex flex-col gap-y-4">
						{errorMessage && <p className="-mx-3 text-red-600 p-3 border-2 border-red-300 bg-red-50 rounded-xl max-w-xl">{errorMessage}</p>}

						<button
							type="submit"
							disabled={Object.values(selectedProducts).every((quantity) => quantity === 0) || isSubmitting}
							className="button-primary  py-2 w-full max-w-xl -mx-3 flex justify-center"
						>
