...
export default function WelcomeMessages() {
	...
	const messageTypes = {
		...
		confirmBeforeSendingFirstInvitation:
			"confirm before sending first invitation",
	...
	const showMessage = {
		...
		[messageTypes.sendFirstInvitation]:
			notJustACustomer && emailConfirmed && noInvitedOrConfirmedCustomers,
		[messageTypes.confirmBeforeSendingFirstInvitation]:
			notJustACustomer && !emailConfirmed && noInvitedOrConfirmedCustomers,
		[messageTypes.trialSubscriptionExpired]:
			(notJustACustomer && !user.trialEnd) ||
			(notJustACustomer && !user.subscriptionEnd),
	};
	...
	return (
		<>
			...
			{showMessage[messageTypes.pleaseConfirmYourEmail] && (
				<PleaseConfirmYourEmailMessage email={user.email} />
			)}

			{showMessage[messageTypes.confirmBeforeSendingFirstInvitation] && (
				<ConfirmBeforeInviting />
			)}
