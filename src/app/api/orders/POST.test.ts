...
import { createDate, january } from '@/library/shared'
import { equals } from '@/library/utilities/server'
import type { AnonymousProduct, AsyncFunction, DangerousBaseUser, JsonData, OrderMade, Product, TestUserInputValues } from '@/types'
...
const anonymousProductInsertValues: AnonymousProduct[] = [{ name: 'Human blood, 5 liters', priceInMinorUnits: 9850, customVat: 20 }]
