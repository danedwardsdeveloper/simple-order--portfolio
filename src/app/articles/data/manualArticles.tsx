import { april, february, serviceConstraints } from '@/library/constants'
...
export const manualArticles: ManualArticlesCollection = {
	...
	about: {
		...
		metaDescription: `Simple Order offers an affordable ${formattedSubscriptionPrice}/month order management system for UK wholesalers. Founded by Dan Edwards in 2025, we simplify wholesale ordering.`,
		featuredImage: imagesCollection.coffee[0],
		...
		content: [
			...
			`At just ${formattedSubscriptionPrice} per month, we're much cheaper than competitors who charge £80-150 monthly.`,
			<h3>We're friction-free</h3>,
			`Start your ${serviceConstraints.trialLength}-day free trial without entering any card details. No risk, no hassle, no sales calls.`,
			...
			`Ready to simplify your ordering process? Start your free ${serviceConstraints.trialLength}-day trial today with no card details required.`,
		],
	},
	'gdpr-compliance': {
		utilityPage: true,
		...
		category: articleCategories.legal,
		featuredImage: imagesCollection.bakery[0],
		content: [
			...
			<h2>Who We Are</h2>,
			<p>
				Simple Order - {bareProductionDomain} - is a wholesale order management platform operated by Dan Edwards, based in the United
				Kingdom. We provide a streamlined platform for wholesalers to manage customer orders online.
			</p>,
			...
			<ul>
				<li>All data is stored on secure servers within the UK</li>
			...
			<p>
				...
				For more information, please see our <Link href={articlePath('cookie-policy')}>Cookie Policy</Link>.
			</p>,
			...
			<h2>Contact Us</h2>,
			<p>If you have any questions about our GDPR compliance or data protection practices, please contact us.</p>,
		],
	},
	'cookie-policy': {
		utilityPage: true,
		...
		featuredImage: imagesCollection.furnitureManufacturer[0],
		category: articleCategories.legal,
		publishedAt: createDate(29, february, 2025),
		content: [
	...
	'terms-of-service': {
		...
		featuredImage: imagesCollection.autoParts[0],
		category: articleCategories.legal,
		publishedAt: createDate(5, february, 2025),
		content: [
			'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
