...
export default function MerchantSettings() {
	...
	return (
		<div className="w-full max-w-md border-2 border-slate-100 rounded-xl p-3 flex flex-col gap-y-6">
			<MinimumSpend minimumSpendPence={user.minimumSpendPence} saveMinimumSpendPence={saveMinimumSpendPence} />

			<LeadTime leadTimeDays={user.leadTimeDays} saveLeadTime={saveLeadTime} />

			<CutOffTime cutOffTime={user.cutOffTime} saveCutOffTime={saveCutOffTime} />
