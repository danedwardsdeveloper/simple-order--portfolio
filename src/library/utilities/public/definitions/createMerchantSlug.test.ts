...
import { createMerchantSlug } from './createMerchantSlug'
...
describe('Creates valid slugs', () => {
	for (const testCase of testCases) {
		test(testCase.description, () => {
			expect(createMerchantSlug(testCase.input)).toEqual(testCase.expected)
		})
	}
})

/* 
pnpm vitest src/library/utilities/public/definitions/createMerchantSlug
*/
